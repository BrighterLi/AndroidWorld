...
public class FileUtils {
    ...
    // todo list ? java.io.IOException: No such file or directory
    ...
    public File write2SDFromInput(String fileName, String dir, InputStream input) {
        ...
        try {
            ...
            System.out.println("bright8#write2SDFromInput#写数据异常：" + e);
        } finally {
            try {
                if (output != null) {
                    output.close();
                ...
                System.out.println("bright8#write2SDFromInput#写数据异常2：" + e2);
            }
        }
        return file;
    }
