    ...
    private void doRetrofit() {
        ...
        callShops.enqueue(new Callback<ShopBean>() {
            ...
            public void onResponse(Call<ShopBean> call, Response<ShopBean> response) {
                Toast.makeText(RetrofitDemoActivity.this,response.body().toString(),Toast.LENGTH_LONG).show();
    ...
    private void request() {
        ...
        baidu.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                Toast.makeText(RetrofitDemoActivity.this,"code:"+response.code()+"  " + "body:" + response.body(),Toast.LENGTH_LONG).show();
