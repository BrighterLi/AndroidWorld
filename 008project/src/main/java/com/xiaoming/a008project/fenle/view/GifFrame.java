package com.xiaoming.a008project.fenle.view;
...
import com.xiaoming.a008project.fenle.tool.ImageUtil;
...
public class GifFrame {
        ...
        public void run() {
            if (isRunning && mListener != null) {
                ...
                if (num > 0) {
                    ...
                    mCurrentIndex = index;
                    getGlideBitmap(index, new ImageUtil.OnBitmapLoad() {
                        @Override
    ...
    private void getGlideBitmap(int index, final ImageUtil.OnBitmapLoad onBitmapLoad) {
