...
public class MyWebView4 extends WebView {
    private int mScrollY;
    private int mScrollHeadHeight = 300;


    public MyWebView4(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyWebView4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyWebView4(Context context) {
        this(context, null);
    }
