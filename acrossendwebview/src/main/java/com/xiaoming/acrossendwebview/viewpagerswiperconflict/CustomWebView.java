...
public class CustomWebView extends WebView {
    ...
    ViewpagerSwiperConflitActivity.PlaceholderFragment webViewFragment;
    ...
    public void setFragment(ViewpagerSwiperConflitActivity.PlaceholderFragment webViewFragment) {
