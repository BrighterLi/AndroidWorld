...
public class MyInstrumentation extends Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle) {
        Log.e("Main", "bright9#走了我的callActivityOnCreate");
        Log.e("Main", "bright9#activity = " + activity);
        Log.e("Main", "bright9#activity class = " + activity.getClass());
        Log.e("Main", "bright9#activity resource = " + activity.getResources());

        try {
            //拿到ContextWrapper类中的字段mBase字段，就是Context
            Class<?> aClass = activity.getClass();
            Log.e("Main", "bright9#activity aClass = " + aClass);
            Log.e("Main", "bright9#activity aClass aClass = " + aClass.getSuperclass());
            Log.e("Main", "bright9#activity aClass aClass aClass = " + aClass.getSuperclass().getSuperclass());
            ...
            Log.e("Main", "bright9#mBase = " + mBase);
