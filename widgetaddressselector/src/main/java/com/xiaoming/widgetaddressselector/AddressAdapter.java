...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
    ...
    private List<AddressBean> provinceDatas; // 总（省)数据
     ...
     */
    public void refreshData(List<AddressBean> provinceDatas, int dataType, String checkedProvince, String checkedCity, String checkedArea) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.item_address_recycleview, viewGroup, false);
